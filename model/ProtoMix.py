...
import random
import numpy as np
from model.model_utils import mixup_process,sample_step, one_hot
...
class ProtoMix(nn.Module):
    ...
    def forward_train(self,**kwargs):
        ...
        mixed_embed, labels_reweighted = mixup_process(patient_embed, prototype_labels_one_hot,
        ...
        sample_indices = sample_step(self.prototype_embed.clone().detach(), self.positive_frequency, self.negative_frequency, patient_embed,
        ...
        mixed_embed, labels_reweighted = mixup_process(patient_embed_sample, patient_y_true_sample,
                                                       adaptive_alpha=True, mixup_alpha=self.mixup_alpha)

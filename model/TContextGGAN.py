...
from model.TContextGGAN_model import TContextGGANN
...
class TCGGAN(BaseModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.TGGAN = TContextGGANN(128, 128, 128, 128)
    ...
    def forward(self, **kwargs) -> Dict[str, torch.Tensor]:
        ...
        new_patient_emb = patient_emb
        new_patient_emb.append(mask)
        logits = self.TGGAN(new_patient_emb)
